                     ...
                     steps{
                         script {
                             if(!env.sysdig_plugin){    
                                 withCredentials([usernamePassword(credentialsId: 'sysdig-sa-credentials', passwordVariable: 'api_token')]) {
                                    ...
                                    sh "SECURE_API_TOKEN=${api_token} ./sysdig-cli-scanner --apiurl ${sysdig_url} ${sysdig_cli_args} ${registry_url}/${registry_repo}/${docker_tag}"
                                 }
                             }
                             else{
